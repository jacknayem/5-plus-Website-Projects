        ...
        <div class="col-md-10 col px-5 pl-md-2 pt-2 mx-auto flex-collume">
            ...
            <div class="row flex-fill justify-content-around">
                <div class="col-md-5 col border border-1">
                    ...
                    <hr class="mt-0">
                    <form class="form-group pl-4 pr-4 pb-4 pt-0" action="menu_items.php<?=((isset($_GET['edit_ctg']))?'?edit_ctg='.$category_id:'');?>" method="POST" enctype="multipart/form-data">
                        <?php 
                        $food_category='';
                        if(isset($_GET['edit_ctg'])){
                        ...
                        <?php if(isset($_GET['edit_ctg'])): ?>
                            <a href="menu_items.php" class="btn btn-dark mt-1">Cancel</a>
                        <?php endif; ?>
                    ...
                    <div class="scrolable">
                        <table class="table table-dark table-hover text-center ">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td><a href="menu_items.php?edit_ctg=<?= $item_name['id']; ?>"><button class="btn btn-sm btn-default"><i class="fa fa-edit"></i></button></a></td>
                                <td><?= $item_name['name'] ?></td>
                                <td><a href="menu_items.php?delete=<?= $item_name['id']; ?>"><button class="btn btn-sm btn-default"><i class="fa fa-close"></i></button></a></td>
                              </tr>
                              <?php endwhile; ?>
                            </tbody>
                        </table>
                ...
                <div class="col-md-7 col border border-1">
                    ...
                    <hr class="mt-0">
                    <form class="form-group pl-4 pr-4 pb-4 pt-0" action="menu_items.php<?=((isset($_GET['edit']))?'?edit='.$edit_id:'');?>" method="POST" enctype="multipart/form-data">
                        <?php 
                        $food_name='';
                        $food_discription='';
                        $food_price ='';
...
<section class="container fluid">
    ...
    <hr>
    <div class="row pt-3">
        <div class="col-12 p-0 rounded bg-white bhoechie-tab-container">
            <div class="row">
                <div class="col-3 pl-0 pr-0 pb-0 bhoechie-tab-menu">
                    ...
                    <div class="bhoechie-tab-content active">
                        <table class="table table-dark table-hover text-center ">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td><a href="menu_items.php?edit=<?= $items['id']; ?>"><button class="btn btn-sm btn-default"><i class="fa fa-edit"></i></button></a></td>
                                <td><img src="../images/res_img_3.jpg" height="60px" width="120px"></td>
                                <td><?= $items['name'] ?></td>
                                <td><?= $items['discription'] ?></td>
                                <td><?= $items['price'] ?></td>
                                <td><a href="menu_items.php?delete=<?= $items['id']; ?>"><button class="btn btn-sm btn-default"><i class="fa fa-close"></i></button></a></td>
                              </tr>
                              <?php endwhile; ?>
                            </tbody>
                        </table>
